  ...
  return (
    ...
    >
      ...
      <span
        id={tooltipId}
        role="tooltip"
        className="bg-dark tooltip text-light absolute -top-10 left-1/2 z-10 flex w-fit -translate-x-1/2 items-center gap-1.5 rounded-md px-3 py-2 text-xs font-normal whitespace-nowrap opacity-0 shadow-xs transition-opacity duration-300 group-hover:opacity-100 group-focus-visible:opacity-100"
      >
